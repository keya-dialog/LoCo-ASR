...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/LoCo-ASR_v2_AED_conformer_68M_label_smoothing_MELUXINA_mel_fe_augmentations_higher_lr.out

EXPERIMENT="AED_conformer_68M_label_smoothing_MELUXINA_mel_fe_augmentations_higher_lr"
PROJECT="LoCo-ASR_v2"
...
torchrun --standalone \
  ...
  --base_encoder_model="Lakoc/fisher_conformer_enc_14_layers_smaller_hidden" \
  --feature_extractor_name="Lakoc/fisher_log_mel_extractor" \
  --base_decoder_model="Lakoc/fisher_dec_24_layers_smaller_hidden" \
  ...
  --restart_from="${EXPERIMENT_PATH}/checkpoint-79000/" \
  --ignore_data_skip
