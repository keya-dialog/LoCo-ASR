...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/LoCo-ASR_v2-AED_ebranchformer_68M_label_smoothing_MELUXINA_mel_fe_augmentations_fixed_forward.out
