...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/LoCo-ASR_v2_AED_80M_label_smoothing_MELUXINA_mel_fe_augmentations_multi_lm_heads3_tied.out

EXPERIMENT="ASR_v2_AED_80M_label_smoothing_MELUXINA_mel_fe_augmentations_multi_lm_heads3_tied"
PROJECT="LoCo-ASR_v2"
...
torchrun --standalone \
  ...
  --base_decoder_model="Lakoc/fisher_dec_6_layers_multi_head3_tied" \
