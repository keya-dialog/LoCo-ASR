...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/LoCo-ASR_v2-AED_ebranchformer_68M_label_smoothing_MELUXINA_mel_fe_augmentations_higher.out

EXPERIMENT="AED_ebranchformer_68M_label_smoothing_MELUXINA_mel_fe_augmentations_higher"
PROJECT="LoCo-ASR_v2"
...
torchrun --standalone \
  ...
  --base_encoder_model="Lakoc/fisher_ebranchformer_enc_12_layers" \
