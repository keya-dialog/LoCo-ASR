...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/LoCo-ASR_v2_AED_80M_label_smoothing_MELUXINA_mel_fe_augmentations_6_lm_heads.out

EXPERIMENT="ASR_v2_AED_80M_label_smoothing_MELUXINA_mel_fe_augmentations_6_lm_heads"
PROJECT="LoCo-ASR_v2"
...
torchrun --standalone \
  ...
  --base_decoder_model="Lakoc/fisher_dec_6_layers_6_lm_heads" \
