...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/LoCo-AED_branchformer_68M_label_smoothing_MELUXINA_mel_fe_augmentations_higher_restart.out

EXPERIMENT="AED_branchformer_68M_label_smoothing_MELUXINA_mel_fe_augmentations_higher"
PROJECT="LoCo-ASR_v2"
...
torchrun --standalone \
  ...
  --base_encoder_model="Lakoc/fisher_branchformer_enc_12_layers" \
