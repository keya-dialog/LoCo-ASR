...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/LoCo-ASR_v2_AED_80M_label_smoothing_MELUXINA_mel_fe_augmentations_layer_params_as_head.out

EXPERIMENT="ASR_v2_AED_80M_label_smoothing_MELUXINA_mel_fe_augmentations_layer_params_as_head"
PROJECT="LoCo-ASR_v2"
...
torchrun --standalone \
  ...
  --base_decoder_model="Lakoc/fisher_dec_7_layers_params_as_additional_head" \
