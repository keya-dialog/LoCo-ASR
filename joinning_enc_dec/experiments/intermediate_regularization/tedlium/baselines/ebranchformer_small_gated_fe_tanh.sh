...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_gpt2_256h_6l_gated_fe_tanh2.out

EXPERIMENT="tedlium_ebranchformer_gpt2_256h_6l_gated_fe_tanh2"
PROJECT="TED2"
...
torchrun --standalone \
  ...
  --output_dir="/mnt/proj1/open-28-58/lakoc/LoCo-ASR/experiments/TED2_tedlium_ebranchformer_gpt2_256h_6l_gated_fe_tanh" \
  ...
  --apply_gated_encoder \
  --ignore_data_skip \
  --restart_from="/mnt/proj1/open-28-58/lakoc/LoCo-ASR/experiments/TED2_tedlium_ebranchformer_gpt2_256h_6l_gated_fe_tanh/checkpoint-119472/"
