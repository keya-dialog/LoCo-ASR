...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_medium_more_tokens_v2.out

EXPERIMENT="tedlium_ebranchformer_medium_more_tokens_v2"
PROJECT="TED2"
