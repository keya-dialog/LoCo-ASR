...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_gpt2_256h_6l_adaptive.out

EXPERIMENT="tedlium_ebranchformer_gpt2_256h_6l_adaptive"
PROJECT="TED2"
