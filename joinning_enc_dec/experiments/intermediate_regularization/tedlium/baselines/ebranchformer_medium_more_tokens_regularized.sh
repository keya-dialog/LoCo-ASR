...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_medium_more_tokens_regularized.out

EXPERIMENT="tedlium_ebranchformer_medium_more_tokens_regularized"
PROJECT="TED2"
