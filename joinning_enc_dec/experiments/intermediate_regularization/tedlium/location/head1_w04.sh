...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_gpt2_256h_6l_add_head1_04.out

EXPERIMENT="tedlium_ebranchformer_gpt2_256h_6l_add_head1_04"
PROJECT="TED2"
...
torchrun --standalone \
  ...
  --base_decoder_model="Lakoc/gpt2_256h_6l_add_head1_04" \
