...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_gpt2_256h_6l_add_head4_05.out

EXPERIMENT="tedlium_ebranchformer_gpt2_256h_6l_add_head4_05"
PROJECT="TED2"
