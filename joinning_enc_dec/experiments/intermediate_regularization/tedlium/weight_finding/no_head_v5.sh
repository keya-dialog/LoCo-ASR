...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_gpt2_256h_6l_no_head_v5.out

EXPERIMENT="tedlium_ebranchformer_gpt2_256h_6l_no_head_v5"
PROJECT="TED2"
