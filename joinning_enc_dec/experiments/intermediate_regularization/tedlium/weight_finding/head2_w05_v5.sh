...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_gpt2_256h_6l_add_head2_05_v5.out

EXPERIMENT="tedlium_ebranchformer_gpt2_256h_6l_add_head2_05_v5"
PROJECT="TED2"
...
torchrun --standalone --nnodes=1 --nproc-per-node=$SLURM_GPUS_ON_NODE \
  ...
  --base_decoder_model="Lakoc/gpt2_256h_6l_add_head2_05" \
