...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_gpt2_256h_6l_no_head_v2.out

EXPERIMENT="tedlium_ebranchformer_gpt2_256h_6l_no_head_v2"
PROJECT="TED2"
