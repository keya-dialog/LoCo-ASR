...
#SBATCH --nodes 1
#SBATCH --time 1:00:00
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_specaug_no_warp_fmask.out

EXPERIMENT="tedlium_ebranchformer_specaug_no_warp_fmask"
PROJECT="TED"
...
torchrun --standalone \
  ...
  --config_overrides="encoder_apply_time_warp=False,encoder_mask_feature_prob=0.00" \
