...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/gpt2_tedlium_additional_head.out

EXPERIMENT="gpt2_tedlium_additional_head"
PROJECT="TED_CLM"
...
torchrun --standalone \
  ...
  --config_name="Lakoc/gpt2_512h_16l_add_head8" \
