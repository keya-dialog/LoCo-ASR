...
#SBATCH --nodes 1
#SBATCH --time 4:00:00
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/joint_decoding_wer_test_shallow_fusion_7_lm04.out

EXPERIMENT="joint_decoding_wer_test_shallow_fusion_7_lm04"
PROJECT="TED"
