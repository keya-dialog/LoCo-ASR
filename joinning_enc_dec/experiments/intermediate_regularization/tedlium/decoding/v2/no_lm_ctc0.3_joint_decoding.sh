...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/ebranchformer_ctc03_joint_decoding_regularized.out

EXPERIMENT="ebranchformer_ctc03_joint_decoding_regularized"
PROJECT="TED"
