...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/ebranchformer8_ctc03_avg.out

EXPERIMENT="ebranchformer8_ctc03_avg"
PROJECT="TED"
...
python \
  ...
  --from_pretrained="/mnt/proj1/open-28-58/lakoc/LoCo-ASR/experiments/TED_tedlium_ebranchformer_tiny_esp_aug_uni500_fixed_pos_proper_scoring_regularization_averaging_v8_avg_test" \
  ...
  --eval_beam_factor="1" \
  --evaluation_splits validation test --joint_decoding_during_training \
  --apply_spec_augment \
