...
#SBATCH --nodes 1
#SBATCH --time 1:00:00
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_specaug.out

EXPERIMENT="tedlium_ebranchformer_specaug"
PROJECT="TED"
...
torchrun --standalone \
  ...
  --config_overrides="encoder_apply_time_warp=True,encoder_mask_feature_prob=0.05" \
