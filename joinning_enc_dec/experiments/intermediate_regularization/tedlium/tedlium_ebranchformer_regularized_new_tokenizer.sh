...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_AED_ebranchformer_regularized_new_tokenizer4.out

EXPERIMENT="tedlium_AED_ebranchformer_regularized_new_tokenizer4"
PROJECT="TED"
