...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_AED_ebranchformer_20s_bpe500_tiny_external_lm.out

EXPERIMENT="tedlium_AED_ebranchformer_20s_bpe500_tiny_external_lm"
PROJECT="TED"
...
torchrun --standalone \
  ...
  --weight_decay="1e-6" \
  --max_grad_norm="5.0" \
  --external_lm="/mnt/proj1/open-28-58/lakoc/LoCo-ASR/experiments/TED_CLM_tedlium_clm_gpt2_smaller" \
