...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_medium3_regularized.out

EXPERIMENT="tedlium_ebranchformer_medium3_regularized"
PROJECT="TED2"
