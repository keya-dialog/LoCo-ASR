...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/tedlium_ebranchformer_tiny_esp_aug_uni_fixed_pos_regularization_on_averaging_v8.out

EXPERIMENT="tedlium_ebranchformer_tiny_esp_aug_uni_fixed_pos_regularization_on_averaging_v8"
PROJECT="TED"
