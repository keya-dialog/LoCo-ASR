...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/common_voice_AED_ebranchformer_unigram1k_czech.out

EXPERIMENT="common_voice_AED_ebranchformer_unigram1k_czech"
PROJECT="CommonVoice"
...
python joinning_enc_dec/src/trainers/train_tokenizer.py \
  ...
  --dataset_config="cs" \
  --tokenizer_name="Lakoc/common_voice_czech_unigram1k" \
  --vocab_size=1000 \
