...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/common_voice_AED_ebranchformer_unigram200_czech.out

EXPERIMENT="common_voice_AED_ebranchformer_unigram200_czech"
PROJECT="CommonVoice"
...
python joinning_enc_dec/src/trainers/train_tokenizer.py \
  ...
  --dataset_config="cs" \
  --tokenizer_name="Lakoc/common_voice_czech_unigram200" \
  --vocab_size=200 \
