...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/fisher_AED_ebranchformer_regularized_bigger_lr.out

EXPERIMENT="fisher_AED_ebranchformer_regularized_bigger_lr"
PROJECT="FISHER_V2"
