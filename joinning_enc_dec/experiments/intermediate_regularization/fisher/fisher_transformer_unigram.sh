...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/LoCo-ASR/outputs/fisher_AED_transformer_unigram.out

EXPERIMENT="fisher_AED_transformer_unigram"
PROJECT="FISHER_V2"
...
torchrun --standalone \
  ...
  --tokenizer_name="Lakoc/fisher_tokenizer_unigram" \
