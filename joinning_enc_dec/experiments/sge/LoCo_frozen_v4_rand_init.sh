...
#$ -l matylda5=10
#$ -l gpu=1,gpu_ram=40G
#$ -o /mnt/matylda5/xpolok03/projects/LoCo-ASR/experiments/LoCo_frozen_v4_rand_init.o
#$ -e /mnt/matylda5/xpolok03/projects/LoCo-ASR/experiments/LoCo_frozen_v4_rand_init.e
...
EXPERIMENT="LoCo_frozen_v4_rand_init"
