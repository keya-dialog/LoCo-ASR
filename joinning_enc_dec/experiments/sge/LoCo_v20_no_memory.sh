...
#$ -l matylda5=10
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda5/ipoloka/projects/LoCo-ASR/experiments/LoCo_v20_no_memory.o
#$ -e /mnt/matylda5/ipoloka/projects/LoCo-ASR/experiments/LoCo_v20_no_memory.e
