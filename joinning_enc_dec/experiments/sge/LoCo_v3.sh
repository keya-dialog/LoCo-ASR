...
#$ -l matylda5=10
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda5/xpolok03/projects/LoCo-ASR/experiments/LoCo_v3.o
#$ -e /mnt/matylda5/xpolok03/projects/LoCo-ASR/experiments/LoCo_v3.e
...
EXPERIMENT="LoCo_decoder_unfrozen"
