...
#$ -l matylda5=10
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda5/xpolok03/projects/LoCo-ASR/experiments/LoCo+cross_attention_v1.o
#$ -e /mnt/matylda5/xpolok03/projects/LoCo-ASR/experiments/LoCo+cross_attention_v1.e
