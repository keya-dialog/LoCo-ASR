...
from context_aware.old.models_v2 import JointCTCAttentionEncoderDecoderWithContextV2
...
if __name__ == '__main__':
    ...
    model = JointCTCAttentionEncoderDecoderWithContextV2.from_encoder_decoder_pretrained(
