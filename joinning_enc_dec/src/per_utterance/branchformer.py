...
class Wav2Vec2BranchformerEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        # 3. Merge
        hidden_states = residual + self.final_dropout(
...
class Wav2Vec2BranchformerPreTrainedModel(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, (Wav2Vec2BranchformerEncoder, MelFeatureExtractor)) or isinstance(module, (
                Wav2Vec2BranchformerEncoder, Wav2Vec2BranchformerFeatureEncoder)):
